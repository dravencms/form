...
class AclOperationFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $operations = [
            'form' => [
                'edit' => 'Umožnuje editaci form',
                'delete' => 'Umožnuje smazání form'
            ]
        ];
    ...
    {
        return ['Dravencms\Model\Form\Fixtures\AclResourceFixtures', 'Dravencms\Model\User\Fixtures\GroupFixtures'];
    }
}